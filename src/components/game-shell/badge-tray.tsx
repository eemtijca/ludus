 ...
 * Selos nunca diminuem; ao serem conquistados, pulsam.
 */

import { Medal, ScanSearch, KeyRound } from "lucide-react";
import type { BadgeId } from "@/lib/progress";

const BADGES: { id: BadgeId; label: string; hint: string; Icon: typeof Medal }[] = [
  { id: "lente", label: "Lente", hint: "Exploração completa", Icon: ScanSearch },
  { id: "chave", label: "Chave", hint: "Análise desvendada", Icon: KeyRound },
  { id: "selo-final", label: "Selo Final", hint: "Decisão de mestre", Icon: Medal },
];
        ...
        return (
          <li key={id}>
            ...
            >
              ...
              <span className="sr-only">{earned ? "conquistado" : "a conquistar"}</span>
            </div>
          </li>
        );
      })}
